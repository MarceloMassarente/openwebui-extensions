...
- **GitHub Copilot SDK** (`github-copilot-sdk`): 深度集成 GitHub Copilot SDK 的强大 Agent (v0.13.1)。支持 OpenWebUI 0.9.x 全面兼容、纯 BYOK 模式、智能意图识别、自主网页搜索与上下文压缩。
