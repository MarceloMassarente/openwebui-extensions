...
| `BYOK_BASE_URL` | `""` | BYOK Base URL（OpenAI 例：`https://api.openai.com/v1` 有 /v1；Anthropic 例：`https://api.anthropic.com` 无版本后缀；其他供应商可能不同，请查阅供应商文档） |
...
详见 [SKILLS_MANAGER_CN.md](https://github.com/Fu-Jie/openwebui-extensions/blob/main/plugins/pipes/github-copilot-sdk/SKILLS_MANAGER_CN.md)
...
- [publish_file_from_workspace 使用指南](https://github.com/Fu-Jie/openwebui-extensions/blob/main/plugins/pipes/github-copilot-sdk/PUBLISH_FILE_FROM_WORKSPACE_CN.md)
...
- [Skills 最佳实践](https://github.com/Fu-Jie/openwebui-extensions/blob/main/plugins/pipes/github-copilot-sdk/SKILLS_BEST_PRACTICES_CN.md)
