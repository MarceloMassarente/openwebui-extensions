...
- [GitHub Copilot SDK](github-copilot-sdk.zh.md) (v0.12.3) - GitHub Copilot SDK 官方集成。具备**工作区安全隔离**、**零配置工具桥接**与**BYOK (自带 Key) 支持**。**v0.12.2 更新：`manage_skills` 支持多行 `SKILL.md` frontmatter，并改进 YAML 回写稳定性**。[查看深度架构解析](github-copilot-sdk-deep-dive.zh.md) | [**查看进阶 实战教程**](github-copilot-sdk-tutorial.zh.md) | [**查看详细使用手册**](github-copilot-sdk-usage-guide.zh.md)。
